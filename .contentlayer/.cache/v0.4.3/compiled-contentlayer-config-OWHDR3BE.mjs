...
var require_siteMetadata = __commonJS({
  "data/siteMetadata.js"(exports, module) {
    var siteMetadata2 = {
      ...
      author: "John Xu",
      headerTitle: "",
      description: "Explore the world of technology as a professional senior software engineer. Find technical passages, instructional videos, and innovative software projects.",
      theme: "system",
...
var Blog = defineDocumentType(() => ({
  ...
  computedFields: {
    ...
    lang: {
      type: "string",
      resolve: (doc) => {
        const restPath = doc._raw.flattenedPath.replace(/^.+?(\/)/, "");
        if (restPath.includes("en/")) {
          return "en";
        }
        return "cn";
      }
...
//# sourceMappingURL=compiled-contentlayer-config-OWHDR3BE.mjs.map
